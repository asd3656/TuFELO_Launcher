...
- 상대방의 닉네임이 클랜원 목록에 있어야 합니다.(대소문자 무시)
- **상대방의 닉네임 판별 로직은 정확한일치 -> `(백틱) 또는 ](대괄호) 뒤 닉네임비교 순으로 우선순위가 책정됩니다. 예를들어 Tyr, TuF`Tyr, ASD]tyr 모두 Tyr로 인식합니다. **
- Tyran, tyr`tuf 모두 미확인 상대로 인식합니다. 미확인 상대로 인식 할 시 사용자 본인이 런처에서 상대방 닉네임을 지정합니다.
